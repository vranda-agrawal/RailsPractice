class WorkersController < ApplicationController
  ...
  def show
    ...
    puts params
    worker_obj=Worker.find(params[:id])
    worker_obj.delay(queue:"worker",priority: 20,run_at: 5.minutes.from_now).send_mail()
    worker_obj.delay(queue:"worker",priority: 28,run_at: 5.minutes.from_now).notify_user()
  end
  ...
  private
    ...
    def worker_params
      params.require(:worker).permit(:fname, :lname)
    end
end
